...
#include <cstdint>
#include <glm/glm.hpp>
// [ACKN] ChatGPT was used for back and forth design discussions when designing this class.
// Code was predominantly written by me, where it is generated by ChatGPT it is explicitly noted.
/**
...
private:
    ...
    // [ACKN] ChatGPT helped to fix a bug related to mushroom positioning when terrain height changes.
    // Store world X/Z coordinates for each mushroom (parallel to allMushrooms)
    // Used to update Y position when terrain height changes
    std::vector<glm::vec2> mushroomWorldXZ;
