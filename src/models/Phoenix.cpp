...
void Phoenix::update(float dt) { 
	...
	glm::vec3 modelFront = glm::vec3(1.0f, 0.0f, 0.0f); // TODO: Tune until it is the correct start
	AxisAngle axisAngle = rotationFromTo(modelFront, direction);
	...
	rotationAngle = baseRotationAngle + axisAngle.angle;
