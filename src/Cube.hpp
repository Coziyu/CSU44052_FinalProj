...
// A simple Cube class for test rendering a cube in the scene
struct Box {
...
inline GLuint LoadShadersFromString(std::string VertexShaderCode, std::string FragmentShaderCode)
{
	// Create the shaders
